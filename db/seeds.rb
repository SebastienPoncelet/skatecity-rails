...
Spot.create(name: "Icon X Skatepark", description: "Wooden indoor park in Shanghai with fun looking street area with all the usual and a nice looking mini ramp.", user_id: u2, address: "Shanghai loushanguanlu 35")
